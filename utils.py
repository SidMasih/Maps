...
def key_of_min_value(d):
    ...
    checks for min first and then returns the key of the min value
    ...
    """
    # BEGIN Question 0
    return [x for x, y in d.items() if y == min([y for x,y in d.items()])][0]
    # END Question 0
...
def enumerate(s, start=0):
    ...
    """
    # BEGIN Question 0
    return zip([element for element in range(0+start, start + len(s))],s)
    # END Question 0
